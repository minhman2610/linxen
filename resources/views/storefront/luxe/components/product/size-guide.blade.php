...
<div class="lx-size-assistant">
    ...
    <button class="lx-size-toggle" type="button" data-size-toggle>
        📏 Chưa chắc chọn size? <strong>Nhận gợi ý size</strong>
    </button>
    ...
    <div class="lx-size-panel" hidden>
        ...
        <div class="lx-size-form">
            ...
            <input type="number" id="size-height" placeholder="Chiều cao (cm)">
            <input type="number" id="size-weight" placeholder="Cân nặng (kg)">
            <input type="number" id="size-bust" placeholder="Ngực (cm)">
            <input type="number" id="size-waist" placeholder="Eo (cm)">
            <input type="number" id="size-hip" placeholder="Mông (cm)">
